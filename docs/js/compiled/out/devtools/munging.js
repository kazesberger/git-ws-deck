...
var o22606 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22606["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22607 = temp__5718__auto____$1;
return (o22607["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22137__auto__ = f;
return (o__22137__auto__["toString"]).call(o__22137__auto__);
} else {
return "";
}
}catch (e22613){var _ = e22613;
return "";
}});
...
try{var o__22137__auto___22629 = t;
(o__22137__auto___22629["cljs$lang$ctorPrWriter"]).call(o__22137__auto___22629,t,writer);
}catch (e22622){var __22630 = e22622;
}
...
var char_code = (function (){var o__22137__auto__ = (new String(char$));
return (o__22137__auto__["charCodeAt"]).call(o__22137__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22137__auto__ = String;
return (o__22137__auto__["fromCharCode"]).call(o__22137__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22653 = num_code;
switch (G__22653) {
case (1):
return (185);
...
var o__22137__auto__ = String;
return (o__22137__auto__["fromCharCode"]).call(o__22137__auto__,superscript_code);
});
/**
...
}catch (e22679){var _e__22151__auto__ = e22679;
return false;
}})())){
...
var vec__22682 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22682,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22707 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22707["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22708 = temp__5718__auto____$1;
return (o22708["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___22749 = arguments.length;
var i__4642__auto___22751 = (0);
while(true){
if((i__4642__auto___22751 < len__4641__auto___22749)){
args__4647__auto__.push((arguments[i__4642__auto___22751]));

var G__22754 = (i__4642__auto___22751 + (1));
i__4642__auto___22751 = G__22754;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22731){
var vec__22732 = p__22731;
var ns_detector = cljs.core.nth.call(null,vec__22732,(0),null);
...
var G__22767 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22768 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22767;
remaining_tokens = G__22768;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22719){
var G__22720 = cljs.core.first.call(null,seq22719);
var seq22719__$1 = cljs.core.next.call(null,seq22719);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22720,seq22719__$1);
});
...
var vec__22758 = cljs.core.split_with.call(null,(function (p1__22755_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22755_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22758,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22758,(1),null);
...
var vec__22764 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22764,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22764,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22793 = cljs.core.rest.call(null,remaining_tokens);
var G__22794 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22793;
name_tokens = G__22794;
continue;
} else {
...
var vec__22780 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22780,(0),null);
var arity = cljs.core.nth.call(null,vec__22780,(1),null);
var vec__22783 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22783,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22783,(1),null);
var vec__22786 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22786,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22786,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22786,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22786,(3),null);
...
var vec__22804 = result;
var munged_ns = cljs.core.nth.call(null,vec__22804,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22804,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22804,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22804,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22804,(4),null);
var arity = cljs.core.nth.call(null,vec__22804,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22813 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22813,(0),null);
var args = cljs.core.nth.call(null,vec__22813,(1),null);
var vec__22817 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22817,(0),null);
var name = cljs.core.nth.call(null,vec__22817,(1),null);
...
var G__22859 = (arity + (1));
var G__22860 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22849){
var vec__22850 = p__22849;
var arity = cljs.core.nth.call(null,vec__22850,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22850,(1),null);
...
return cljs.core.get.call(null,arities,p1__22861_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22862_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___22895 = arguments.length;
var i__4642__auto___22896 = (0);
while(true){
if((i__4642__auto___22896 < len__4641__auto___22895)){
args__4647__auto__.push((arguments[i__4642__auto___22896]));

var G__22897 = (i__4642__auto___22896 + (1));
i__4642__auto___22896 = G__22897;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22875){
var vec__22876 = p__22875;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22876,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22867){
var G__22868 = cljs.core.first.call(null,seq22867);
var seq22867__$1 = cljs.core.next.call(null,seq22867);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22868,seq22867__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22911__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22911__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22911__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22911__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22919 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22919,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22919,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22919,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22919,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22919,(4),null);
var arity = cljs.core.nth.call(null,vec__22919,(5),null);
...
var o__22137__auto__ = f;
return (o__22137__auto__["getBasis"]).call(o__22137__auto__);
});
/**
...
}catch (e22933){var _e__22151__auto__ = e22933;
...
var G__22947 = (obj[cljs.core.first.call(null,path)]);
var G__22948 = cljs.core.rest.call(null,path);
obj = G__22947;
path = G__22948;
continue;
} else {
...
return (function (accum,p__22960){
var vec__22961 = p__22960;
var bit = cljs.core.nth.call(null,vec__22961,(0),null);
var protocol = cljs.core.nth.call(null,vec__22961,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22969){
var vec__22970 = p__22969;
var ns = cljs.core.nth.call(null,vec__22970,(0),null);
var name = cljs.core.nth.call(null,vec__22970,(1),null);
var selector = cljs.core.nth.call(null,vec__22970,(2),null);
...
return (function (p__22978){
var vec__22979 = p__22978;
var munged_name = cljs.core.nth.call(null,vec__22979,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22979,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22979,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22975_SHARP_){
return (obj[cljs.core.first.call(null,p1__22975_SHARP_)]);
});})(name,sorted_matches,vec__22979,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1547634622116
