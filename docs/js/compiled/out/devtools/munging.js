...
var o__22136__auto__ = f;
return (o__22136__auto__["toString"]).call(o__22136__auto__);
} else {
return "";
}
}catch (e22612){var _ = e22612;
return "";
}});
...
try{var o__22136__auto___22627 = t;
(o__22136__auto___22627["cljs$lang$ctorPrWriter"]).call(o__22136__auto___22627,t,writer);
...
var char_code = (function (){var o__22136__auto__ = (new String(char$));
return (o__22136__auto__["charCodeAt"]).call(o__22136__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22136__auto__ = String;
return (o__22136__auto__["fromCharCode"]).call(o__22136__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22650 = num_code;
switch (G__22650) {
case (1):
return (185);
...
var o__22136__auto__ = String;
return (o__22136__auto__["fromCharCode"]).call(o__22136__auto__,superscript_code);
});
/**
...
}catch (e22671){var _e__22144__auto__ = e22671;
return false;
}})())){
...
var vec__22674 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22674,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22696 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22696["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22697 = temp__5718__auto____$1;
return (o22697["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___22721 = arguments.length;
var i__4642__auto___22722 = (0);
while(true){
if((i__4642__auto___22722 < len__4641__auto___22721)){
args__4647__auto__.push((arguments[i__4642__auto___22722]));

var G__22724 = (i__4642__auto___22722 + (1));
i__4642__auto___22722 = G__22724;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22711){
var vec__22712 = p__22711;
var ns_detector = cljs.core.nth.call(null,vec__22712,(0),null);
...
var G__22733 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22734 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22733;
remaining_tokens = G__22734;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22704){
var G__22705 = cljs.core.first.call(null,seq22704);
var seq22704__$1 = cljs.core.next.call(null,seq22704);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22705,seq22704__$1);
});
...
var vec__22728 = cljs.core.split_with.call(null,(function (p1__22726_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22726_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22728,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22728,(1),null);
...
var vec__22738 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22738,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22738,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22748 = cljs.core.rest.call(null,remaining_tokens);
var G__22749 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22748;
name_tokens = G__22749;
continue;
} else {
...
var vec__22756 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22756,(0),null);
var arity = cljs.core.nth.call(null,vec__22756,(1),null);
var vec__22759 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22759,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22759,(1),null);
var vec__22762 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22762,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22762,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22762,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22762,(3),null);
...
var vec__22783 = result;
var munged_ns = cljs.core.nth.call(null,vec__22783,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22783,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22783,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22783,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22783,(4),null);
var arity = cljs.core.nth.call(null,vec__22783,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22797 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22797,(0),null);
var args = cljs.core.nth.call(null,vec__22797,(1),null);
var vec__22802 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22802,(0),null);
var name = cljs.core.nth.call(null,vec__22802,(1),null);
...
var G__22835 = (arity + (1));
var G__22836 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22843){
var vec__22844 = p__22843;
var arity = cljs.core.nth.call(null,vec__22844,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22844,(1),null);
...
return cljs.core.get.call(null,arities,p1__22878_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22879_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___22901 = arguments.length;
var i__4642__auto___22902 = (0);
while(true){
if((i__4642__auto___22902 < len__4641__auto___22901)){
args__4647__auto__.push((arguments[i__4642__auto___22902]));

var G__22903 = (i__4642__auto___22902 + (1));
i__4642__auto___22902 = G__22903;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22893){
var vec__22894 = p__22893;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22894,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22887){
var G__22888 = cljs.core.first.call(null,seq22887);
var seq22887__$1 = cljs.core.next.call(null,seq22887);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22888,seq22887__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22929__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22929__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22929__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22929__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22935 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22935,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22935,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22935,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22935,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22935,(4),null);
var arity = cljs.core.nth.call(null,vec__22935,(5),null);
...
var o__22136__auto__ = f;
return (o__22136__auto__["getBasis"]).call(o__22136__auto__);
});
/**
...
}catch (e22953){var _e__22144__auto__ = e22953;
...
var G__22955 = (obj[cljs.core.first.call(null,path)]);
var G__22956 = cljs.core.rest.call(null,path);
obj = G__22955;
path = G__22956;
continue;
} else {
...
return (function (accum,p__22959){
var vec__22960 = p__22959;
var bit = cljs.core.nth.call(null,vec__22960,(0),null);
var protocol = cljs.core.nth.call(null,vec__22960,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22964){
var vec__22965 = p__22964;
var ns = cljs.core.nth.call(null,vec__22965,(0),null);
var name = cljs.core.nth.call(null,vec__22965,(1),null);
var selector = cljs.core.nth.call(null,vec__22965,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22971,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22971,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22971,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22968_SHARP_){
return (obj[cljs.core.first.call(null,p1__22968_SHARP_)]);
});})(name,sorted_matches,vec__22971,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1547626115258
