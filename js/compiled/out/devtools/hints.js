...
var map__25544 = top_item;
var map__25544__$1 = (((((!((map__25544 == null))))?(((((map__25544.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25544.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25544):map__25544);
var file = cljs.core.get.call(null,map__25544__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25544__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25544__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25543){var _e = e25543;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___25546 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___25546)){
var seen_errors_25547 = temp__5718__auto___25546;
if(cljs.core.truth_(seen_errors_25547.has(self))){
} else {
seen_errors_25547.add(self);

var temp__5720__auto___25548 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___25548)){
var sense_25549 = temp__5720__auto___25548;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25549)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1547626116644
